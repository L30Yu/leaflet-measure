    ...
    (L.Control.Measure = L.Control.extend({
      ...
      initialize: function(e) {
        ...
        var t = this.options,
          r = t.activeColor,
          n = t.completedColor,
          o = t.disabledClassName;
        (this.disabledClassName = o),
      ...
      _updateDisabled: function() {
        var e = this.disabledClassName || 'leaflet-disabled';
        L.DomUtil.removeClass(this._container, e),
          this._disabled && L.DomUtil.addClass(this._container, e);
      },
      ...
      _expand: function() {
        this._disabled || (f.hide(this.$toggle), f.show(this.$interaction));
      },
      _collapse: function() {
    ...
    function n(e, t, r) {
      ...
      S || (P = 'with (obj) {\n' + P + '\n}\n'),
        ...
        (P =
          ...
          'return __p\n}');
      var A = i(function() {
        return Function(w, E + 'return ' + P).apply(void 0, L);
      });
